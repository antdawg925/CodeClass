    ...
    return (
        <div className="scroll_info text-center" data-bs-spy="scroll" data-bs-target="#simple-list-example" data-bs-offset="0" data-bs-smooth-scroll="true" tabIndex="0" style={{ marginBottom: "2rem" }}>
            <div className='bg-secondary box_limiter' style={{ width: "50vw", minHeight: "fit-content", minWidth: "60vw" }}>
                ...
                <div className="box_border apply_boxes d-flex flex-column justify-content-between align-items-center" >
                    <h5 className='class_info_header'>Weekly Web Development</h5>
                    <p>
                        6-week course <br />
                    ...
                    <button className="rounded bg-danger w-50 mb-2" onClick={() => Navigate("/apply")}>Apply</button>
                </div>
                <p>
            ...
            <div className='box_limiter' style={{ width: "50vw", minHeight: "fit-content", minWidth: "60vw" }}>
                ...
                <div className="box_border apply_boxes d-flex flex-column justify-content-between align-items-center" >
                    <h5 className='class_info_header'>Full-Stack Starter Course </h5>
                    <p>
                        4-week course <br />
                        Tuesday/Thursday <br />
                        6:00pm - 8:00pm PST
            ...
            <div className='bg-secondary box_limiter' style={{ width: "50vw", minHeight: "fit-content", minWidth: "60vw" }}>
                ...
                <div className="box_border apply_boxes d-flex flex-column justify-content-between align-items-center" >
                    <h5 className='class_info_header'>Cloud Deployment</h5>
                    <p>
                        6-week course <br />
                        Monday/Wednesday <br />
                        6:00pm - 8:00pm PST
            ...
            <div className='box_limiter' style={{ width: "50vw", minHeight: "fit-content", minWidth: "60vw" }}>
                ...
                <div className="box_border apply_boxes d-flex flex-column justify-content-between align-items-center" >
                    <h5 className='class_info_header'>Algo Training </h5>
                    <p>
                        4-week course <br />
                        Monday or Wednesday <br />
            ...
            <div className='bg-secondary box_limiter' style={{ width: "50vw", minHeight: "fit-content", minWidth: "60vw" }}>
                ...
                <div className="box_border apply_boxes d-flex flex-column justify-content-between align-items-center" >
                    <h5 className='class_info_header'>AI Development</h5>
                    <p>
                        7-week course <br />
                        Monday/Wednesday <br />
